...
#[
    ...
    OA\Server (url: 'https://laravel-swagger-ah.azurewebsites.net/api', description: "staging server"),
    OA\Server(url: 'https://laravel-swagger-ah.azurewebsites.net/api', description: "production server"),
